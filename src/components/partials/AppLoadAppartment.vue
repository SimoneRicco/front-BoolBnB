...
<template>
  <section class="mt-24 p-4">
    <div class="grid gap-6 mb-6 md:grid-cols-2">
      <div>
        <label
          ...
          >Nome della struttura</label
        >
        <input
          type="text"
          id="name"
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          placeholder="Inserisci il nome della tua struttura"
          required
        />
      </div>
      ...
      <div class="w-full md:w-1/3 mb-6 md:mb-0">
        ...
        <div class="relative mb-3" data-te-input-wrapper-init>
          ...
          <label
            ...
            class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-200 dark:peer-focus:text-primary block mb-2 text-sm font-medium text-gray-900 dark:text-white"
            >Metri quadrati
          </label>
        </div>
      </div>
      ...
      <label
        for="message"
        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
        >Descrizione della struttura</label
      >
      <textarea
        id="message"
        rows="4"
        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        placeholder="Parlaci della struttura"
      ></textarea>

      <label
        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
        for="file_input"
        >Inserisci l'immagine di copertina della tua struttura</label
      >
      <input
      ...
      <label
        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
        for="multiple_files"
        >Inserisci le immagini della tua struttura</label
      >
      <input
        class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
        id="multiple_files"
    ...
    <div>
      <button
        class="flex text-white text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
        type="button"
      ...
      >
        ...
        Scegli una delle nostre promozioni!
      </button>
    </div>
    ...
    <div
      ...
      class="fixed top-0 right-0 z-40 h-screen pt-24 p-4 overflow-y-auto transition-transform translate-x-full bg-white w-3/4 dark:bg-gray-800"
      tabindex="-1"
    ...
    >
      ...
      >
        <svg
          class="pe-2 w-6 h-6 text-gray-900 dark:text-white"
          aria-hidden="true"
          xmlns="http://www.w3.org/2000/svg"
          fill="currentColor"
          viewBox="0 0 18 20"
      ...
      <p class="mb-6 text-sm text-gray-500 dark:text-gray-400">
        Affidati ai nostri abbonamenti esclusivi. Sul nostro sito, puoi
        facilmente sottoscrivere tre diversi abbonamenti che si adattano alle
        tue esigenze: mensile, trimestrale e annuale.
      </p>
      <div class="planes flex gap-2 mb-4">
        <div
          class="h-1/2 w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700"
        >
          ...
          <button
            type="button"
            class="text-white bg-red-300 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center"
          >
            Scegli Abbonamento
          </button>
        </div>
        <div
          class="w-full h-1/2 max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700"
        >
          <h5 class="mb-4 text-xl font-medium text-gray-500 dark:text-gray-400">
            Abbonamento gold
          </h5>
          <div class="flex items-baseline text-gray-900 dark:text-white">
            <span class="text-3xl font-semibold">€</span>
            <span class="text-5xl font-extrabold tracking-tight">69</span>
            <span
              class="ml-1 text-xl font-normal text-gray-500 dark:text-gray-400"
              >/mese</span
            >
    ...
    <button
      type="submit"
      class="text-white bg-red-300 hover:bg-red-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
    >
