...
<template>
  <div
    class="animate-rotate-y animate-once h-screen bg-cover contact bg-[url('https://images.unsplash.com/photo-1533681852052-dba7a3e4ef81?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=871&q=80')]"
  >
    <div class="h-screen flex flex-col justify-center">
      <h1 class="text-center text-5xl">Entra in contatto con noi</h1>
  ...
  <div class="flex my-12">
    <div class="w-1/2 flex justify-center items-center">
      <div class="left">
        <h1 class="mb-12 text-4xl">Scrivici sui nostri social!</h1>
    ...
    <div class="w-1/2 flex justify-center items-center">
      <div class="right gap-x-5 flex">
        <div class="location w-1/2">
          <h1 class="mb-4 text-2xl">
            Ci puoi trovare a Milano nel centro della città!
          </h1>
          <span
            >Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ut
            dolorem molestiae repellendus id necessitatibus iste itaque
            doloribus?</span
          >
        </div>
        <div class="description w-1/2">
          <span
            ...
            impedit. Exercitationem fuga provident iure quas magnam porro,
            inventore et eos fugit deserunt praesentium eius, nobis laborum
            iusto laboriosam! Nobis, nihil.</span
          >
        </div>
      </div>
    </div>
  </div>
  <h1 class="text-3xl my-3.5 text-center">Iscriviti alla nostra newsletter</h1>
  <div
    class="border-solid border-2 border-dark-600 mt-6 m-auto block max-w-md rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700"
  >
    <form>
